...
public class ProductController {
    ...
    public BaseResponse<ProductRes> getProductDeatilById(@PathVariable("productId") int productId) {
        ...
        if (cachedData != null) {
            ...
            log.info("product 실행 : id/" + productId);// 실행 시간 측정 시작
            try {
                // 데이터 베이스에서 값 조회
                ...
                cacheService.setWithExpiration("appProducts" + productId, jsonString, optionService.getOption("appProducts").getExpiredTime());
