...
public interface IMetadataControllerV1 {
	...
	ResponseEntity<AdminSuccessResponse<?>> deleteMetadata(@RequestParam String path);
	...
	ResponseEntity<AdminSuccessResponse<?>> isExistMetadata(@RequestParam String path);
