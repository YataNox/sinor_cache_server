...
public interface IApiServiceV1 {
	 ...
	 */
	ApiGetResponse findCacheById(String key) throws BaseException;

	/**
	 * 패턴과 일치하는 캐시 조회
	 * @param pattern 조회할 캐시들의 공통 패턴
	 */
	List<ApiGetResponse> findCacheList(String pattern) throws BaseException;
	 ...
	 */
	ApiGetResponse saveOrUpdate(String key, String value, int expiredTime) throws BaseException;
