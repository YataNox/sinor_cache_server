...
public interface IMetadataService {
	 ...
	 */
	MetadataGetResponse updateMetadata(String url, int newExpiredTime);

	/**
	 * 옵션 삭제
	 * @param url 삭제할 url 값
	 */
	void deleteMetadataById(String url);
	 ...
	 */
	MetadataGetResponse	createMetadata(String url, int expiredTime);
}
